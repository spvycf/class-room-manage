...
<div class="left">
    ...
    <el-menu default-active="/notice" router>
      ...
      <el-submenu index="1" >
        ...
        <el-menu-item index="/user"><i class="el-icon-user"></i>我的信息</el-menu-item>
        ...
        <template slot="title">
          ...
          <el-menu-item index="/noticeManage" ><i class="el-icon-info"></i>公告管理</el-menu-item>
      </el-submenu>
